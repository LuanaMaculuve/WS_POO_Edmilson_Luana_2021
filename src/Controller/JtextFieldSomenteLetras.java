...
somente numeros em determinadas textFields.
*/
public final class JtextFieldSomenteLetras extends JTextField {
    ...
    private void jTextFieldKeyTyped(KeyEvent evt) {
        ...
        String caracteres="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";// conjunto de caracteres que nao devem ser aceites no preencimento das textFields
